...
import ProductReviesCard from './ProductReviesCard'
import { mens_kurta } from '../../../Data/mens_kurta'
import HomeSectionCard from '../HomeSectionCard/HomeSectionCard'
import { useNavigate } from 'react-router-dom'

const product = {
  name: 'Basic Tee 6-Pack lg-px-20',
  price: '$192',
  href: '#',
  breadcrumbs: [
    { id: 1, name: 'Men', href: '#' },
        ...
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8
         lg:pb-24">
          <div className="lg:col-span-2">
            ...
            <h1 className='text-lg lg:text-xl text-gray-900 opacity-60 pt-1'>Casual Puff Sleeves Solid Women White Top
            </h1>
          </div>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            {/* Reviews */}
            <div className="mt-6">
                <div className='flex item-center spece-x-4'>
                <Rating name="read-only" value={3.5} readOnly />
                <p className='opacity-50 text-sm'>5623 Ratings</p>
                <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3251 Reviews</p>
                </div>
                ...
                <Grid container spacing={7}>
                    <Grid item xs={7}>
                        <div className='space-y-5'>
                           {[1,1,1].map((item)=> <ProductReviesCard/>)}
                        </div>
                    </Grid>
                    <Grid item xs= {5}>
                        ...
                        <div className='flex item-center space-x-3'>
                            ...
                            <p className='opacity-60'>5434 Ratings</p>
                        </div>
