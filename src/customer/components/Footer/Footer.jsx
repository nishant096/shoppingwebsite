    ...
    <div>
      <Grid className='bg-black text-white text-center mt-10' container sx={{ bgcolor: 'black', color: 'white', py: 3 }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          ...
          <div><Button className='pb-5' variant='h6' gutterBottom>{" "}Guide</Button></div>
        ...
        <Grid className='pt-20' item xs = {12}>
            <Typography variant="body2" component="p" align="center">
                &copy; 2023 Nishant's Company. All rights reserved.
            </Typography>
            <Typography variant='body2' component="p" align="center">
            ...
            {' '}from{' '}
            <Link href="https://www.flaticon.com/" color='inherit' underline='alwats'>
                www.flaticon.com
            </Link>
            </Typography>
